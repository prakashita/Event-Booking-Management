...
async def init_db():
    ...
    from models import ApprovalRequest, ChatConversation, ChatMessage, Event, FacilityManagerRequest, InstitutionCalendarEntry, Invite, IQACFile, ItRequest, MarketingRequest, PendingRoleAssignment, Publication, TransportRequest, User, Venue, WorkflowActionLog
    from idempotency import IdempotencyRecord

    # Initialize Beanie with the database and document models
    await init_beanie(
        database=client[DB_NAME],
        document_models=[User, Venue, Event, InstitutionCalendarEntry, ApprovalRequest, FacilityManagerRequest, MarketingRequest, ItRequest, TransportRequest, Invite, Publication, PendingRoleAssignment, ChatConversation, ChatMessage, IQACFile, WorkflowActionLog, IdempotencyRecord]
    )
